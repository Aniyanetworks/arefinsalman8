...
// Soft blurred orbs for the animated gradient background
const ORBS = [
...
// Candidate initials for portrait placeholder
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 w-full py-36 lg:py-40">
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-20 items-center">
          ...
          {/* Portrait placeholder — replace src with an actual <img> when photo is ready */}
          <motion.div
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
                <span
                  className="font-display text-7xl font-bold text-white/15 select-none"
                  aria-hidden="true"
                >
                  {initials}
                </span>
      ...
      >
        <motion.div
          className="w-6 h-10 rounded-full border-2 border-white/20 flex justify-center pt-1.5"
        >
          <motion.span
